...
export default function MobileDock() {
  return (
    <nav className="mobile-study-dock" aria-label="Navegação mobile Logic Quest">
      ...
      <button type="button" onClick={() => scrollToSelector(".editor-panel")}>Estudar</button>
      <button type="button" onClick={() => document.querySelector(".playground-top-button")?.click()}>Código</button>
